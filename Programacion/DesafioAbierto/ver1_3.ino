...
void adelante(){
  direccion.write(80); // Posicion del servo para avanzar (ajustar segun tu servo)
...
void loop() {
  ...
  if(k == 1){ // Si el boton fue activado
    ...
    if (vuelta < 3){ // Mover el carro por 3 vueltas
      ...
      // Si no hay obstaculos cercanos o despues de girar, avanzar
      adelante();
